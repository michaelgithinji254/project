...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 01, 2024 at 12:35 PM
...
INSERT INTO `appointments` (`id`, `farmer_id`, `vet_id`, `appointment_date`, `appointment_time`, `status`, `vet_message`) VALUES
(1, 1, 3, '2024-07-30', '03:43:00', 'accepted', 'what'),
(2, 1, 3, '2024-07-30', '03:43:00', 'pending', NULL),
(3, 1, 3, '2024-07-25', '15:51:00', 'pending', NULL),
(4, 1, 3, '2024-07-25', '15:51:00', 'pending', NULL),
(5, 4, 3, '2024-07-31', '18:09:00', 'pending', NULL);
...
(3, 'amy@gmail.com', 'Amy Waringa', 'veterinary', 'Embu', '$2y$10$wFLsZMAFyvpjnUAFnqsDW./b3XepGbqNPNkyfbsuwAPZeVwkTLxSG', '2024-07-26 07:43:55', '2024-07-26 07:43:55'),
(4, 'daniel@gmail.com', 'daniel githinji', 'farmer', 'Embu', '$2y$10$2Yjnn6c5yIn.QUxWe6Vymu7eQY.gLgr9GVJeQown4A7bh1SqmJ3HK', '2024-07-26 10:03:56', '2024-07-26 10:03:56');
...
--
ALTER TABLE `appointments`
  ADD CONSTRAINT `appointments_ibfk_1` FOREIGN KEY (`farmer_id`) REFERENCES `users` (`id`),
